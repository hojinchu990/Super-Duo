...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        mHolder.away_name.setContentDescription(",");                   //Add 15.10.08 12:44

        mHolder.date.setText(cursor.getString(COL_MATCHTIME));
        mHolder.date.setContentDescription(",");                        //Add 15.10.08 12:45

        mHolder.score.setText(Utilies.getScores(cursor.getInt(COL_HOME_GOALS), cursor.getInt(COL_AWAY_GOALS)));
        mHolder.score.setContentDescription(",");                       //Add 15.10.08 12:46
        ...
        if(mHolder.match_id == detail_match_id)
        {
            ...
            league.setContentDescription(Utilies.getLeague(cursor.getInt(COL_LEAGUE))); //Add 15.10.08 12:50
